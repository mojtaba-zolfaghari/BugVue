...
(function() {
  ...
  this.VKI_clearPasswords = false;  // Clear password fields on focus
    this.VKI_imageURI = document.URL+ "/lib/keyboard/keyboard.png";  // If empty string, use imageless mode
  ...
  /* ***** i18n text strings ************************************* */
  this.VKI_i18n = {
    '00': "نمایش صفحه کلید کامل",
    '01': "نمایش کیبورد",
    '02': "انتخاب قالب کیبورد",
    '03': "Dead keys",
    '04': "روشن",
    '05': "خاموش",
    '06': "بستن کیبورد",
    '07': "پاک کردن",
    '08': "پاک کردن این ورودی",
    '09': "Version",
    '10': "کوچک کردن صفحه کلید",
    '11': "بزرگ کردن صفحه کلید"
  };
  ...
  if (!this.VKI_layout[this.VKI_kt])
    return alert('هیچ کیبوردی با این نام وجود ندارد :  "' + this.VKI_kt + '"');
